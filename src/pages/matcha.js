      ...
      <main id="site-main" className="site-main transition-fade">
        <div className="row">
          ...
          <div className="col-9">
            ...
            <p>
              Matcha is our passion. We have been to tea farms, tea factories
              and matcha shops in Japan and China several times for enriching
              our matcha knowledge. We want to explore all the possibilities of
              using matcha, and bring complete matcha experience to people in
              the Netherlands.
            </p>
            <Img
            ...
            <p>
              Matcha is a type of green tea powder. It is made of the youngest,
              finest leaves that are carefully handpicked and ground slowly to
            ...
            <p>
              <b>NO.201 Premium Baking:</b> Our selected premium baking matcha
              will add a rich flavour and vivid colour to your baking. Of course
              you can also make drinks with it.
            </p>
            <p>
            ...
            <p>
              ...
              <Link to={`/workshop-event`}>Workshop & Event</Link> page or
