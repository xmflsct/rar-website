      ...
      <div className="row">
        <div className="col-12 col-md-6">
          ...
          <p>
            ...
            {' '}
Pure Cacao Cake Roll, Seasalt-Oreo Cream,
        ...
        <div className="col-12 col-md-6">
          ...
          <p>
            <strong>Flavour:</strong>
            {' '}
Pure Matcha Cake Roll, Raspberry Cream,
      ...
      <p>
        <strong>Size:</strong>
        {' '}
Only complete roll can be pre-ordered. One
...
3 days (below 5 °C)
      ...
      <p>
        ...
        {' '}
        {' '}
        <Link to="/shop-info#contact">email or call us</Link>
        {' '}
to check
