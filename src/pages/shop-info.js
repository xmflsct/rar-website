            ...
            <Accordion defaultActiveKey="0">
              ...
              <Accordion.Collapse eventKey="0">
                <Card.Body>
                  ...
                  <p>
                    Everyday we have fresh baked cakes in the shop, the flavor
                    may vary. Cakes in the shop can be ordered on a first come
                    first served basis.
                  </p>
                  <p>
                    If you want to order a specific cake, we advise you to
                    pre-order it. All the cakes that are shown on the Cakes &
                    Hightea Page are available for pre-ordered. We advise you to
                    order our cakes 5 days in advance for certainty.
                  </p>
                  <p>
                    If you want a cake for today or tomorrow, please call us to
              ...
              <Accordion.Toggle as={Card.Title} eventKey="1">
                Q: I want a special pattern/ text on my cake roll, is it
                possible?
              </Accordion.Toggle>
              <Accordion.Collapse eventKey="1">
                <Card.Body>
                  <p>
                    A: It is possible! We can draw simple shapes or patterns
                    like bunny, cat or tree... A short text can also be written
                    on the cake roll. This extra service will cost 2 euro/per
                    roll. Feel free to contact us for details.
                  </p>
                </Card.Body>
              </Accordion.Collapse>
              ...
              <Accordion.Collapse eventKey="2">
                <Card.Body>
                  <p>
                    A: Basically, you can combine any cake/cream flavour we
                    have, then you have your own cake roll flavour. Need help or
                    suggestions? Please call us.
                  </p>
                </Card.Body>
              </Accordion.Collapse>
              ...
              <Accordion.Collapse eventKey="3">
                <Card.Body>
                  <p>
                    A: Our high-tea menu is updated seasonally and we need time
                    to prepare special items for high tea. Therefore, a
                    reservation is needed. We suggest you book your high-tea 5
                    days in advance. Our high-tea can be reserved for minimal 2
                    people.
                  </p>
                  <p>
                    For cancellation, please let us know at least 24 hours prior
                    to your appointment.
                  </p>
                  <p>
                    <b>
                      <i>
                        If you cancel your booking less than 24 hours, 50% of
              ...
              <Accordion.Collapse eventKey="4">
                <Card.Body>
                  <p>
                    A: We only take seat reservation for a group of 6 people or
                    more. If you might be late, please give us a call. Otherwise
                    the reservation will be cancelled after 15 mins.
                  </p>
                </Card.Body>
              </Accordion.Collapse>
              ...
              <Accordion.Collapse eventKey="5">
                <Card.Body>
                  <p>
                    ...
                    requirement has been told when you pre-order the cake roll.
                    During busy business hours we may have no time to slice the
                    cake, since we are with limited amount of staff, and it is
                    fun to slice the cake into the size you want!
                  </p>
                </Card.Body>
              </Accordion.Collapse>
              ...
              <Accordion.Collapse eventKey="6">
                <Card.Body>
                  <p>
                    A: For large orders, please contact us as early as possible
                    for the certainty. We will give you a discount if you order
                    10 or more cakes.
                  </p>
                  <p>
                    You may call us or you can email us at:
                    info@roundandround.nl
                  </p>
                </Card.Body>
              </Accordion.Collapse>
              ...
              <Accordion.Toggle as={Card.Title} eventKey="7">
                Q: I'd like to have your cakes for a wedding or a party. How do
                I book my order?
              </Accordion.Toggle>
              <Accordion.Collapse eventKey="7">
                <Card.Body>
                  <p>
                    A: For wedding & Party cakes, please check here (wedding
                    cake page) to see examples. The price of the cake is
                    different in every case, depending on the amount of guests,
                    and the decoration etc. So we suggest you give us a call or
                    visit our shop for more information. Of course we can design
                    your Wedding & Party cake together!
                  </p>
                </Card.Body>
              </Accordion.Collapse>

              <Accordion.Toggle as={Card.Title} eventKey="8">
                Q: I am interested in featuring your cakes and sweets on our
                menu, How do I go about it?
              </Accordion.Toggle>
              <Accordion.Collapse eventKey="8">
                <Card.Body>
                  <p>
                    A: Please contact us by email info@roundandround.nl, and we
                    can arrange an appointment for tasting. We can also design
