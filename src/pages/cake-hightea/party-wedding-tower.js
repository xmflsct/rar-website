...
const PartyWeddingTower = ({ location }) => {
  const data = useStaticQuery(graphql`
    {
      allMarkdownRemark(
        filter: { fileAbsolutePath: { regex: "/(cake-hightea/party-wedding-tower)/" } }
    ...
    <div className="site-wrapper cake-hightea">
      ...
      <main id="site-main" className="site-main transition-fade">
        <div className="row">
          ...
          <div className="col-9">
            <h3 className="mb-3">Party/Wedding Tower</h3>

            <p>How to order a cake roll tower for your wedding or party?<br />
Please <Link to="/shop-info#contact">contact us</Link> for possibilities.</p>
