        ...
        <div className="row">
          ...
          <div className="col-9">
            ...
            <p>
              ...
              mascarpone, bio-jam and fresh fruit. The birthday cakes below can
              be pre-ordered by sending us an email, calling us or Facebook
              messaging us. You can just let us know the style number. Please
              order 5 days in advance for certainty.
            </p>
            <p>
              Usually we will put "Happy Birthday" chocolate tag and Bunny
              cookies as shown in the cake photos. If you want to skip it,
              please let us know. If you want other text than "Happy Birthday",
              it is possible to have a paper message tag on the cake. Please
              leave us the message when you place the order (please keep the
              message short).
            </p>
            ...
            <p>
              <b>Base:</b> 3 layers of 8” Chiffon cakes (Default flavour Matcha,
              you can also choose Vanilla/ Cacao).
              <br />
              ...
              <br />
              <i>
                * We use seasonal flowers. If you have any color theme
