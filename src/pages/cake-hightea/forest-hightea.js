        ...
        <div className="row">
          ...
          <div className="col-9">
            ...
            <p>
              ...
              . Please place your order 5 days in advance for certainty. Minimal
              2 people.
            </p>
            <Img fluid={data.allFile.nodes[0].childImageSharp.fluid} />
            <h5 className="mt-4">
              1. ChaCha Date Hightea (Autumn/Winter Special)
            </h5>
            ...
            <p>
              Please read our <Link to="/shop-info#q-a">Q&A</Link> for more info
              about Hightea reservation and cancellation policy.
            </p>
          </div>
        </div>
      </main>
